...
export class CreateTodasLasTablas1746089013239 implements MigrationInterface {
    name = 'CreateTodasLasTablas1746089013239'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categoria" ("id" SERIAL NOT NULL, "fecha" date NOT NULL, "area" text, "Marca" character varying(50) NOT NULL, "Modelo" character varying(50) NOT NULL, "Tipo" character varying(50) NOT NULL, "descripcionTrabajo" text, "Cantidad" numeric(5,2) NOT NULL, "Material" text, "Acciones" character varying(50) NOT NULL, CONSTRAINT "PK_f027836b77b84fb4c3a374dc70d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "productos" ("id" SERIAL NOT NULL, "nombre" character varying(250) NOT NULL, "precio" numeric(10,2) NOT NULL, "stock" integer NOT NULL, "image" character varying(250), "descripcion" text, "estado" boolean NOT NULL DEFAULT true, "categoriaId" integer NOT NULL, CONSTRAINT "PK_04f604609a0949a7f3b43400766" PRIMARY KEY ("id"))`);
